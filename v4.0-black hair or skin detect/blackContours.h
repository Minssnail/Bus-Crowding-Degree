...
using namespace cv;
using namespace std;
#define CONTOUR_THRESHOLD_MIN 1 //相对数值
#define CONTOUR_THRESHOLD_MAX 20000000 //连通域轮廓//按面积
...
void crowdHierarchy(int count, float objArea, Mat frame,Mat detectArea,Rect ROI);//拥挤度等级判定
#endif